...
func NewFinish(ambient, diffuse, shiny float64) Finish {
	return Finish{ambient: ambient, diffuse: diffuse, shiny: shiny}
}

func DefaultFinish() Finish {
	return NewFinish(0.1, 0.7, 0)
}

func ShinyFinish() Finish {
	return NewFinish(0.1, 0.7, 0.5)
}
